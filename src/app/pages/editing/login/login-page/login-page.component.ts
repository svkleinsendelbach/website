...
export class LoginPageComponent {
  ...
  public async loginWithEmail() {
      ...
      const registrationStatus = await this.authService
          .loginWithEmail(['editEvents', 'editNews', 'editReports', 'authenticateUser', 'notification'], this.inputForm.field('email').value, this.inputForm.field('password').value)
  ...
  public async loginWithApple() {
      ...
      const registrationStatus = await this.authService
          .loginWithApple(['editEvents', 'editNews', 'editReports', 'authenticateUser', 'notification'])
  ...
  public async loginWithGoogle() {
      ...
      this.inputForm.reset();
      const registrationStatus = await this.authService
          .loginWithGoogle(['editEvents', 'editNews', 'editReports', 'authenticateUser', 'notification'])
